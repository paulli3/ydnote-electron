    ...
    $.fn.extend({
        "scrollBar": function (options) {
            ...
            var horizontalDiv = '<div class="zl-scrollBarBox" style="width:100%;left:0;height:' + settings.barWidth + 'px;bottom:0;">' +
                ...
                '</div>';
            var verticalDiv = '<div class="zl-scrollBarBox" style="height:100%;top:0;width:' + settings.barWidth + 'px;right:'+settings.barWidth+'px;">' +
            ...
            function creatScrollBar(obj) {
                ...
                function addVerticalBar(a) {
                    ...
                    innerH = $(a).height();
                    var barHeight = outerH * (innerH / scrollH) / 2; 
                    verticalBar = $(a).find(".zl-scrollBarBox").remove().end().append(verticalDiv).find(".zl-verticalBar");
                    verticalBar.height(barHeight);
                    $(This).hover(()=>{
                        verticalBar.fadeIn(200);
                    },()=>{
                        verticalBar.fadeOut(200);
                    })
                };
